                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="categorias.php"><i class="glyphicon glyphicon-share"></i>   Categorías</a>
                                </li>
                                <li>
                                    <a href="../Publicaciones.php"><i class="glyphicon glyphicon-folder-open"></i>   Publicaciones</a>
                                </li>
                                <li>
                                    <a href="personas.php"><i class="glyphicon glyphicon-user"></i>   Usuarios</a>
                                </li>
                                 <li>
                                    <a href="tipos.php"><i class="glyphicon glyphicon-info-sign"></i>   Tipos de usuarios</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
